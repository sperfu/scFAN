...
def main():
    ...
    t1 = subprocess.getstatusoutput('rm -f %s/scFAN_predict_using_H1/*.npy'%(input_dirs[0]))
    t2 = subprocess.getstatusoutput('rm -f %s/scFAN_predict_using_GM/*.npy'%(input_dirs[0]))
    t3 = subprocess.getstatusoutput('rm -f %s/scFAN_predict_using_K562/*.npy'%(input_dirs[0]))
    '''
